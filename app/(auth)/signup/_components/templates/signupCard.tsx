...
export default function SignupCard() {
  ...
  return (
      <motion.div
          ...
          className="w-full h-fit flex flex-col-reverse md:flex-row-reverse items-center rounded-2xl text-foreground-0 relative"
      >
        ...
        <div className={'flex w-full md:min-w-[500px] md:w-1/2 h-full md:h-fit absolute inset-0 md:inset-auto md:top-0 md:bottom-0 md:right-0 md:m-auto items-center justify-center z-0 md:z-auto opacity-20 md:opacity-100'}>
          <img className={'lg:w-4/5 w-full aspect-video'} src={'/Routem_Mock/brushStroke_3.png'}/>
        </div>

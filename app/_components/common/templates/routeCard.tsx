...
const RouteCard: FC<RouteCardProps> = ({
  ...
  return (
    <div
      className="relative w-full max-w-2xl overflow-hidden rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer"
      onClick={onClick}
    ...
    >
      ...
      <div className="relative flex items-center justify-between gap-3 p-3">
        ...
        <div className="shrink-0 text-xs">
          <span className="inline-flex items-center gap-1 rounded-full border border-white/40 bg-black/20 px-2 py-1 text-white">
            <svg
